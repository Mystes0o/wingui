...
from utils.rotypes.idldsl import define_winrt_com_method, generics_cache, define_winrt_com_delegate, pinterface_type, GUID
from utils.rotypes import delegate, HSTRING
